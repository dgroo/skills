...
| `story`              | Verbatim story capture with zero derail — file a paragraph of intent as a "not yet pondered" stub in `design/stories/drafts/<slug>.md` and return to the work at hand. The rung between `/idea` (a sentence) and `/ponder` (think now); later `/ponder <slug>` develops the stub                                                                                                                                       |
